        ...
        <Toolbar className={classes.padding}>
          <Tabs className={classes.appbar}>
            ...
            >
                ...
                <MenuItem className={classes.menuItem} onClick={handleRedirectAbout}>ABOUT</MenuItem>
                <MenuItem className={classes.menuItem} onClick={handleRedirectPortfolio}>PORTFOLIO</MenuItem>
                <MenuItem className={classes.menuItem} onClick={handleRedirectContact}>CONTACT</MenuItem>
            </Menu>
            {/* <Link className={classes.link, "navtab"} to="/">
                <Tab className={window.location.pathname === "/" ? classes.activeTab : classes.tabs} label="Home"/>
            </Link> */}
            <Link className={classes.link, "navtab"} to="/">
                <Tab className={window.location.pathname === "/" ? classes.activeTab : classes.tabs} label="About"/>
            </Link>
